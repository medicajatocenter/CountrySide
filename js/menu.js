...
const MENU = {
  ...
  piatti_baby: {
    ...
    nome: "Piatti Baby",
    items: [
      { id: "baby_piatto_pollo_hamburger", nome: "Piatto baby (pollo panato o hamburger + patatine)", prezzo: 6.00, composizione: false,{ attivo: true, prezzo: 2.50, nome: "Menu + patatine e bibita (+€2,50)" } },
